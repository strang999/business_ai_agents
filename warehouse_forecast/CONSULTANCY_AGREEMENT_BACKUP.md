...
**Consultant Rate:** $50/hour USD

**Working Schedule:**
- Approximately 4 hours per day
- Flexible hours based on project needs
- Total estimated: 28-32 hours for PoC week

### 2.2 Project Estimates

**Phase 1 (PoC) - 1 Week:**
- Estimated hours: 28-32 hours (4hrs/day × 7 days)
- **Total Cost: $1,400 - $1,600**
- Fixed price option: **$1,500**

**Phase 2 (If approved) - 2-3 Weeks:**
- Estimated hours: 60-80 hours
- **Total Cost: $3,000 - $4,000**
- Fixed price option: **$3,500**

**Combined Total (Both Phases):**
- Time & Materials: $4,400 - $5,600
- Fixed Price: $5,000

### 2.3 Payment Terms

**Option A: Hourly (Time & Materials)**
- Invoice submitted weekly
- Timesheet attached showing daily hours
- Payment due within 7 business days
- Tracked via time tracking tool (Toggl/Clockify)

**Option B: Fixed Price (Recommended for PoC)**
- **PoC:** $1,500 fixed
  - 50% ($750) upon contract signing
  - 50% ($750) upon delivery
- **Phase 2** (if proceeding): $3,500 fixed
  - 40% ($1,400) at start
  - 60% ($2,100) upon completion

**Option C: Milestone-Based**
- Day 1-2 complete: $400
- Day 3-4 complete: $500
- Day 5-6 complete: $400
- Final delivery: $200
...
**Invoicing:**
- PoC: Single invoice at completion
...
[Specify jurisdiction - Ukraine, Poland, EU, etc.]
...
**Agreement Version:** 1.1 (GDPR Compliant)  
