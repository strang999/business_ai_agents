...
def create_receptionist_agent():
    return Agent(
        ...
        description="You are Sarah, a friendly and professional AI receptionist for 'Apex Solutions'.",
        instructions=[
...
def run_receptionist():
    ...
    print("\n" + "="*50)
    print("📞 INBOUND CALL SIMULATOR - APEX SOLUTIONS")
    print("="*50)
    print("Agent: Hello! Thanks for calling Apex Solutions. I'm Sarah, an AI assistant. How can I help you today?")
