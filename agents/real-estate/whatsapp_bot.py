...
try:
    from main import PropertyFindingAgent
except ImportError:
    # If running from root, adjust import
    sys.path.append(os.path.join(os.getcwd(), 'agents', 'real-estate'))
    from main import PropertyFindingAgent
...
class WhatsAppSimulator:
    ...
    def start_conversation(self):
        print("\n" + "="*40)
        print("📱 WHATSAPP BUSINESS ACCOUNT - REAL ESTATE BOT")
        print("="*40)

        self.send_message("Hello! 👋 I'm Sarah, your AI Real Estate Assistant.")
